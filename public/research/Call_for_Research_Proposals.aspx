...
<main class="container mx-auto px-4 py-8 md:py-12">
  ...
  <a href="https://www.sbbusba.edu.pk/sbbu-main/research-funding-opportunities.html?utm_source=chatgpt.com" 
     ...
     class="block mb-8 md:mb-12 animate-slide-in group">
    <div class="bg-gradient-to-br from-[#1a4d7c] to-[#3674B5] rounded-2xl shadow-2xl p-8 md:p-12 text-white overflow-hidden relative hover:shadow-3xl transition-all duration-500 hover:-translate-y-1">
      <!-- Background Pattern -->
      ...
      <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div class="flex-shrink-0">
          <div class="bg-white text-[#1a4d7c] px-8 py-4 rounded-xl font-bold text-lg shadow-lg group-hover:bg-[#A1E3F9] group-hover:scale-110 transition-all duration-300 flex items-center gap-3">
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 animate-fade-in-up">
    <div class="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#3674B5] hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
      <div class="text-center">
        <div class="bg-gradient-to-br from-[#3674B5] to-[#578FCA] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <p class="text-gray-600">
          Access a wide range of funding opportunities from international organizations, national bodies, and research institutions
        </p>
      </div>
    </div>

    <div class="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#578FCA] hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
      <div class="text-center">
        <div class="bg-gradient-to-br from-[#578FCA] to-[#A1E3F9] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
    ...
    <div class="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#A1E3F9] hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
      <div class="text-center">
        <div class="bg-gradient-to-br from-[#A1E3F9] to-[#578FCA] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
  ...
  <div class="bg-gradient-to-br from-[#f0f9ff] to-white rounded-2xl shadow-xl p-6 md:p-10 border border-gray-200 mb-12">
