    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
      ...
      <aside class="lg:col-span-1">
        <div class="sticky-sidebar sticky top-20">
          ...
          <nav class="bg-gray-300 rounded-xl shadow-lg p-3 mt-3">
            <ul class="space-y-2">
              <li>
              ...
              <li>
                <button data-target="sops"
                  ...
                  <i class="fas fa-clipboard-list mr-2"></i>SOPs for Current Projects
                </button>
              </li>
              <li>
                <button data-target="monitoring-report"
                  class="tab-btn w-full h-12 text-left px-4 py-3 rounded-lg font-medium">
                  <i class="fas fa-file-alt mr-2"></i>Monitoring & Evaluation Report
                </button>
              </li>
            </ul>
          </nav>
